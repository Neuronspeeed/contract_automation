...
class ContractAssistant:
    ...
    def create_assistant(self):
        ...
        try:
            return self.client.beta.assistants.create(
                ...
                instructions="""
                You are a specialized assistant in collecting contract information.
                1. Determine the contract type:
                    - airbnb
                    - buy-sell
                    - it consulting
                2. Collect ID documents and phone numbers
    ...
    def _get_system_prompt(self) -> str:
        return """
        You are a specialized contract processing assistant. Guide users through:

        1. CONTRACT TYPE
        - Determine desired contract type (airbnb/buy-sell/it)
        - Extract from conversation or ask explicitly

        2. DOCUMENTS
        - Request ID documents
        - Verify format (.png, .jpg, .jpeg)
        - Minimum 2 documents needed
        ...
        Guide naturally and verify all information.
        """
